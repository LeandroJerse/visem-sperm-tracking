...
from src.core.paths import VISEM_CLINICAL_ROOT, VISEM_METADATA_ROOT

# Default locations inside the immutable VISEM source tree.
DEFAULT_VIDEOS_CSV = VISEM_METADATA_ROOT / "videos.csv"
DEFAULT_ANALYSIS_CSV = VISEM_CLINICAL_ROOT / "semen_analysis_data.csv"
