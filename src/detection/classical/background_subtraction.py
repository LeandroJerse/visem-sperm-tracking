...
class MOG2Detector(BackgroundSubtractionDetector):
    """Named MOG2 variant for one-algorithm-per-run experiment configs."""

    name = "mog2"

    def __init__(self, **kwargs) -> None:
        kwargs.pop("method", None)
        super().__init__(method="MOG2", **kwargs)


class KNNDetector(BackgroundSubtractionDetector):
    """Named KNN variant for one-algorithm-per-run experiment configs."""
