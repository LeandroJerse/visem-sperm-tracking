...
for name in ('docs/projeto/RELATORIO_COMPLETO_TCC.html', 'RELATORIO_COMPLETO_TCC.html', 'docs/projeto/mapa-tcc-didatico.html', 'MAPA_TCC_DIDATICO.html'):
    ...
    if meta:
        ...
        assert meta['scientific_state_date'] == '2026-09-11'
        assert meta['documentation_only_expansion'] is False
...
out = ROOT / 'tmp/tcc_report/qa_20260911_classical_final_retry1/static_checks.json'
