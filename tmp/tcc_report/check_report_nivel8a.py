...
reports = []
cache = {}
for name in ('docs/projeto/RELATORIO_COMPLETO_TCC.html', 'RELATORIO_COMPLETO_TCC.html'):
    page = Page(ROOT / name)
    ...
    if meta:
        ...
        assert len(meta['top_level_chapters']) == 15
...
out = ROOT / 'tmp/tcc_report/qa_20260909_nivel8a/static_checks.json'
